...
def _report_button(meta: dict, day: str) -> list[list[dict]]:
    ...
    return [[{"text": "⚠️ Тут ошибка или изменение", "callback_data": data}]]
...
HELP = ("👋 Бот расписания МПГУ.\n\n"
        ...
        "Расписание разбирается автоматически, поэтому две вещи ловятся "
        "только с вашей помощью: <b>если мы что-то распознали неверно</b> и "
        "<b>если расписание изменили, а мы ещё не подхватили</b>. "
        "Нажмите кнопку под расписанием или напишите "
        "<code>/oshibka ВОП40-ПФК2501 что не так</code> — читаем каждое "
        "сообщение, расписание обязано совпадать с деканатом.")
